...
const Step3Form = () => {
  ...
  const handleAddEducation = () => {
    appendEducation({institution: "", url: "", area: "", studyType: "In-premise", startDate: new Date(), endDate: new Date(), score: "" });
  };
            ...
            <FormItem className='m-2'>
              ...
              <FormControl>
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input {...field} placeholder='Comptia a+' />
                  )}
                />
              </FormControl>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    ...
                    <FormMessage>{errors.education?.certificates?.[index]?.date?.message}</FormMessage>
                  </FormItem>
                )}
              />
            </div>
            ...
            <FormItem className='m-2'>
              ...
              <FormControl>
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <Input {...field} placeholder='URL' type='url' value={field.value || undefined} />
                  )}
                />
              </FormControl>
